...
sql_command = 'CREATE TABLE youpinhui (ID INTEGER PRIMARY KEY, 品类 TEXT, 商品名称 TEXT, 日常价 TEXT, 双12价 TEXT, 商品链接 TEXT, 推荐理由)'
...
for nrow in range(nrows):
    if nrow == 0:
        ...
        insert_item_comand = 'INSERT INTO youpinhui(ID, 品类, 商品名称, 日常价, 双12价, 商品链接, 推荐理由) VALUES ' \
                            '(%d, \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\")' % (ID, sheet.cell_value(nrow, 0),
